...
class DeviceType(models.Model):
    ...
    disk_ssd = models.CharField(_('Host Disk SSD'), max_length=20, default='NULL')
    disk_sas = models.CharField(_('Host Disk SAS'), max_length=20, default='NULL')
    disk_sata = models.CharField(_('Host Disk SATA'), max_length=20, default='NULL')
    nic = models.CharField(_('Host NIC Card'), max_length=20, default='Onboard')
    psu = models.IntegerField(_('Host PSU'), default=1)
    raid_card = models.CharField(_('Device RAID Card'), max_length=20, default='NULL')
...
class OSType(models.Model):
    ...
    desc = models.CharField(_('OS Description'), max_length=40, default='Extra info.')
...
class Cluster(models.Model):
    ...
    desc = models.CharField(_('Cluster Description'), max_length=40, default='Extra info.')
